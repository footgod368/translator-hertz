...
type QueryUserRequest struct {
	Keyword  *string `thrift:"Keyword,1,optional" json:"Keyword,omitempty" form:"keyword" json:"keyword,omitempty" query:"keyword"`
...
type UserServiceUpdateUserResult struct {
	Success *UpdateUserResponse `thrift:"success,0,optional" json:"success,omitempty"`
}
...
type UserServiceDeleteUserResult struct {
	Success *DeleteUserResponse `thrift:"success,0,optional" json:"success,omitempty"`
}
...
type UserServiceQueryUserResult struct {
	Success *QueryUserResponse `thrift:"success,0,optional" json:"success,omitempty"`
}
